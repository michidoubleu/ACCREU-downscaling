...
LU_to_LUC_prior = function(targets.from, targets.to, prior=NULL, keep_areas = "both", min_cutoff=00) {
  prior_off_diag = 0.000001
  ...
  res = downscalr::fienberg(start_mat=matA,target_from=targets.from$value,target_to=targets.to$value)
