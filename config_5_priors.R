EXPERIMENT = "ACCREU_priors" # label for your run, pick something short but descriptive without spaces and valid as part of a filename
...
SCRIPT = "./codes/5_get_priors_for_regional_LUtoLUC_cluster.R"
...
OUTPUT_FILE = "targetLUC.RData" # as produced by a job on the execute-host, will be remapped with EXPERIMENT and cluster/job numbers to avoid name collisions when transferring back to the submit machine.
